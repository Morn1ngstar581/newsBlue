    <?php
    $query = new WP_Query(['post_type' => 'post', 'post_status' => array('publish'), 'posts_per_page' => 1, 'category_name' => 'chp']);
    if ($query->have_posts()):
    global $post;
    $id = $post->ID;
    ?>
    <div class="category">
        <div class="container">
            <div class="category__grid">
                ...
                <?php
                $query = new WP_Query(['post_type' => 'post', 'post_status' => array('publish'), 'posts_per_page' => 3, 'post__not_in' => array($id), 'category_name'=>'chp']);
                ?>
                ...
                <div class="category__item">
                    <div class="category__long">
                        ...
                        <div class="category__body">
                            ...
                            endwhile;
                            ?>
                            <a href="<?php  echo $category_link = get_category_link( 1444 );?> " class="more-news position-news"> Больше новостей ></a>
                        </div>
                    </div>
                </div>
