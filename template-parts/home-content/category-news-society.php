<section class="society">
    <?php
    $query = new WP_Query(['post_type' => 'post', 'post_status' => array('publish'), 'posts_per_page' => 1,  'category_name' => 'society']);
    if ($query->have_posts()):
    global $post;
    $id = $post->ID;
    ?>
            ...
            <div class="category__grid">
                ...
                <div class="category__item">
                    <a href="<?php the_field('banner-3-link', 'option');?> " class="banner__link">
                        <img class="category__banner" src="<?php the_field('banner-3-img', 'option');?> ">
                    </a>
                </div>
    ...
    <?php $query = new WP_Query(['post_type' => 'post', 'post_status' => array('publish'), 'posts_per_page' => 4, 'post__not_in' => array($id),  'category_name' => 'society',]); ?>
                    ...
                    while ($query->have_posts()):
                        ...
                        <div class="post__item" >
                                ...
                                <div class="post__header" >
                                    <?php echo get_the_post_thumbnail('', 'full', array('class' => 'post__img')); ?>
