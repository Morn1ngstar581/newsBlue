                ...
                <div class="extra__grid">
                    ...
                    while ($query->have_posts()):
                        ...
                        <div class="extra__item">
                            ...
                            if (!empty($categories)) {
                                echo '<a  href="' . esc_url(get_category_link($categories[0]->term_id)) . '" class="blue-badge category__badge" >' . esc_html($categories[0]->name) . '</a>';
                            }
                            ?>
                ...
                <?php
                    while ($query->have_posts()):
                      ...
                      <?php
                            $categories = get_the_category();
                            if (!empty($categories)) {
                                echo '<a  href="' . esc_url(get_category_link($categories[0]->term_id)) . '" class="blue-badge news__badge" >' . esc_html($categories[0]->name) . '</a>';
                            }
                            ?>
                        </div>
