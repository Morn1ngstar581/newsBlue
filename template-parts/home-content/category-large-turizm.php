...
<?php
$query = new WP_Query(['post_type' => 'post', 'post_status' => array('publish'),'posts_per_page' => 1, 'category_name' => 'travel',]);
if ($query->have_posts()):
global $post;
$id = $post->ID;
?>
<div class="large">
    <div class="container">
        ...
        <?php
        $query = new WP_Query(['post_type' => 'post', 'post_status' => array('publish'), 'posts_per_page' => 4,'post__not_in' => array($id),'category_name' => 'travel']);
        ?>
        ...
        <div class="large__body">
            <div class="large__grid">
                ...
                <div class="large__item large__item-link">
                    <a class="more-news" href="<?php  echo $category_link = get_category_link( 907 );?>"> Больше новостей ></a>
                </div>
            </div>
